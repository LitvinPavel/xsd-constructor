...
export const mockData: { [key: string]: ComplexTypeInstance[] } = {
  ...
  Entities: [
    {
      id: 'entity_1',
      name: 'Сущность оборудования',
      type: 'Entity',
      annotation: {
        documentation: 'Сущность оборудования А'
      },
      data: {
        EntityUid: 'Object123',
        EntityName: 'Оборудование А',
        EntityID: ksiData1, // Привязка к KSIIdentification
        Properties: []
      }
    },
    {
      id: 'entity_2',
      name: 'Сущность помещения',
      type: 'Entity',
      annotation: {
        documentation: 'Сущность помещения Б'
      },
      data: {
        EntityUid: 'Object456',
        EntityName: 'Помещение Б',
        EntityID: ksiData2,
        Properties: []
      }
    }
  ...
  Properties: [
    {
      id: 'prop_1',
      name: 'Свойство высоты',
      type: 'Property',
      annotation: {
        documentation: 'Свойство высоты объекта'
      },
      data: {
        PropertyUid: 'Property123',
        PropertyName: 'Высота',
        PropertyID: ksiData1, // Привязка к KSIIdentification
        PropertyCond: []
      }
    },
    {
      id: 'prop_2',
      name: 'Свойство ширины',
      type: 'Property',
      annotation: {
        documentation: 'Свойство ширины объекта'
      },
      data: {
        PropertyUid: 'Property456',
        PropertyName: 'Ширина',
        PropertyID: ksiData2,
        PropertyCond: []
      }
